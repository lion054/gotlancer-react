                ...
                <Box display="flex" alignItems="center">
                  ...
                  <Box className={this.props.classes.optional}>
                    ...
                    <Menu
                      ...
                      anchorOrigin={{ vertical: 'bottom', horizontal: 'left' }} // menu should be display below anchor
                    >
                      <MenuItem className={this.props.classes.label} onClick={() => this.props.history.push('/find_freelancer')}>Find Freelancer</MenuItem>
                  ...
                  <Box className={this.props.classes.optional}>
                    ...
                    >
                      ...
                      <MenuItem className={this.props.classes.label} onClick={() => this.props.history.push('/dispute')}>Dispute</MenuItem>
                  ...
                  <Box className={this.props.classes.optional}>
                    ...
                    >
                      ...
                      <MenuItem className={this.props.classes.label} onClick={() => this.props.history.push('/post_offer')}>Post Offer</MenuItem>
                      <MenuItem className={this.props.classes.label} onClick={() => this.props.history.push('/browse_offers')}>Browse Offers</MenuItem>
                      <MenuItem className={this.props.classes.label} onClick={() => this.props.history.push('/offer')}>Offer</MenuItem>
                    </Menu>
                  </Box>
                  <Box className={this.props.classes.optional}>
