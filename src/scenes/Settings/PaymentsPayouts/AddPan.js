...
class AddPan extends PureComponent {
  state = {
    phoneNumber: ''
  }
          ...
          <Grid item lg={8} xs={12} style={{ maxWidth: 600 }}>
            <Box mb={2}>
              <Breadcrumbs aria-label="breadcrumb" separator={<ChevronRight />}>
                ...
                <Typography color="textSecondary">Add PAN ID Number</Typography>
              </Breadcrumbs>
            </Box>
            <Box mb={2}>
              <Typography variant="h5">Add PAN ID Number</Typography>
            </Box>
            ...
            <Box className={this.props.classes.field}>
              <Typography variant="subtitle1">PAN registered email ID</Typography>
              <Typography variant="body2">We need your PAN registred email id for send you money,</Typography>
              <Box mt={2}>
                <OutlinedInput
                  fullWidth
                  margin="dense"
                  placeholder="Enter PAN registered email ID"
                />
              </Box>
            </Box>
            <Box className={this.props.classes.field}>
            ...
            <Box className={this.props.classes.field}>
              <FormControlLabel
                ...
                label={<Typography variant="body2">I attest that I am the owner and have full authorization to this PAN account.</Typography>}
                onClick={() => {}}
              />
            </Box>
            <Box className={this.props.classes.field}>
...
export default withStyles(styles)(AddPan);